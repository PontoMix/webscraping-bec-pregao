...
def bec_pregaoeletronico3(start_date_combined, end_date_combined):
    
    date1 = start_date_combined
    date2 = end_date_combined
    ...
    #Colocando as datas nos devidos campos para fazer a pesquisa avançada
    input_date1 = browser_driver.find_element(By.XPATH, "//*[@id='ctl00_conteudo_DataInicio']")
    input_date1.send_keys(date1)
    input_date2 = browser_driver.find_element(By.XPATH, "//*[@id='ctl00_conteudo_DataFim']")
    input_date2.send_keys(date2)
    
    button_advanced_search = waitWDW.until(EC.element_to_be_clickable((By.XPATH, "//*[@id='ctl00_conteudo_Pesquisa']")))
    button_advanced_search.click()
    
    #Procurando todos os elementos da tabela do Pregão Eletrônico
    pe_oc_acessed = browser_driver.find_elements(By.XPATH, "//*[@id='ctl00_conteudo_Tabela']/tbody/tr/td[1]")[1:]
    ...
    for j in range(len(pe_oc_infos)):
